    ...
    DeployStableSwapHelper
{
    ...
    function setUp() public {
        ...
        clQuoter = new CLQuoter(address(poolManager));
        ...
        poolManager.initialize(poolKeyWithNativeToken, SQRT_RATIO_1_1);
        ...
        poolManager.initialize(poolKeyWithWETH, SQRT_RATIO_1_1);
    ...
    function testQuoteMixedTwoHops_InfiCl_SS() public {
        ...
        assertGt(gasEstimate, 110000);
        assertLt(gasEstimate, 120000);
    }
    ...
    function testQuoteMixedThreeHops_InfiCl_SS_V3() public {
        ...
        assertGt(gasEstimate, 240000);
        assertLt(gasEstimate, 250000);
    }
