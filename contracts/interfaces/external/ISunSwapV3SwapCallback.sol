...
/// @title ISunSwapV3SwapCallback
/// @notice Callback for ISunSwapV3PoolActions#swap
/// @dev Any contract that calls ISunSwapV3PoolActions#swap must implement this interface.
