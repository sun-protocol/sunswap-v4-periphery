...
import {toBalanceDelta, BalanceDelta, BalanceDeltaLibrary} from "v4-core/src/types/BalanceDelta.sol";
...
contract PositionManagerTest is Test, PosmTestSetup, LiquidityFuzzers {
    ...
    function test_tokenURI() public {
        assertEq(lpm.tokenURI(1), "https://sun.io/v4/positions/1");
        assertEq(lpm.tokenURI(10), "https://sun.io/v4/positions/10");
        assertEq(lpm.tokenURI(2), "https://sun.io/v4/positions/2");
        assertEq(lpm.tokenURI(20), "https://sun.io/v4/positions/20");
        assertEq(
            lpm.tokenURI(type(uint256).max),
            "https://sun.io/v4/positions/115792089237316195423570985008687907853269984665640564039457584007913129639935"
        );
