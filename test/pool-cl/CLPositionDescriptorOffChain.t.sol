...
contract CLPositionDescriptorOffChainTest is Test {
    ...
    function setUp() public {
        clPositionDescriptorOffChain =
            new CLPositionDescriptorOffChain("https://sun.io/v4/positions/");
    }

    function test_bytecodeSize() public {
        vm.snapshotValue("CLPositionDescriptorOffChain size", address(clPositionDescriptorOffChain).code.length);

        if (address(clPositionDescriptorOffChain).code.length > 24576) {
    ...
    function testTokenURI() public view {
        ...
        assertEq(tokenURI, "https://sun.io/v4/positions/1");
    ...
    function testTokenURIFuzz(uint256 tokenId) public view {
        ...
        assertEq(
            tokenURI,
            string.concat("https://sun.io/v4/positions/", Strings.toString(tokenId))
        );
    }
